...
bedrock_agent_client = boto3.client('bedrock-agent', region_name='eu-central-1')
...
def create_agent_role_and_policies(agent_name, agent_foundation_model, kb_id=None):
    ...
    inference_profile_arn = (
        ...
        f"inference-profile/{agent_foundation_model}"
    )

    statements = [
        {
            "Sid": "AmazonBedrockAgentInferenceProfilePolicy",
            "Effect": "Allow",
            "Action": [
                "bedrock:InvokeModel"
            ],
